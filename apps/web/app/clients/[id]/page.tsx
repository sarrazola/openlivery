...
import { ArrowLeft, ArrowRight, Bot, Copy, ExternalLink, FileText, Globe2, ImagePlus, Inbox, ListChecks, LoaderCircle, MessageCircle, Pencil, QrCode, Radio, Save, Settings2, ShieldAlert, ShieldCheck, Tag, Trash2, UserCheck, UserRound, Users, UserX } from "lucide-react";
...
import { ContactFieldsView } from "@/components/contact-fields";
...
type Tab = "details" | "agents" | "channels" | "inbox" | "teams" | "tags" | "fields" | "templates" | "portal";
...
export default function ClientDetailPage() {
  ...
  useEffect(() => {
    ...
    if (wanted && (["details", "agents", "channels", "inbox", "teams", "tags", "fields", "templates", "portal"] as const).some((item) => item === wanted)) setTab(wanted as Tab);
  }, []);
  ...
  return <div className="page">
    ...
    {tab === "fields" && <div className="embedded-portal-view"><ContactFieldsView base={`/clients/${client.id}/contact-fields`} /></div>}
