...
// The client is the identity of the business: what it is called, what kind
// of business it is and where it is. Everything about what it does lives in
// its agents, so creating one leads straight into creating the first agent.
export default function NewClientPage() {
  ...
  // The business's timezone; its agents tell the date and time in it.
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const created = await api<Client>("/clients", { method: "POST", body: JSON.stringify({ name: name.trim(), industry: business.industry, business_type: business.businessType, business_custom: business.custom, timezone, is_active: true }) });
      if (logo) {
