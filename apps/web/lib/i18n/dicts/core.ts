...
const en = {
  ...
  shell: {
    ...
    logout: "Log out",
    language: "Language",
    joinDiscord: "Join the community on Discord",
    starOnGithub: "Star OpenLivery on GitHub",
    theme: "Theme",
    themeSystem: "System",
    themeLight: "Light",
    themeDark: "Dark",
...
const es: typeof en = {
  ...
  shell: {
    ...
    language: "Idioma",
    joinDiscord: "Unirse a la comunidad en Discord",
    starOnGithub: "Dar una estrella a OpenLivery en GitHub",
    theme: "Tema",
    themeSystem: "Sistema",
    themeLight: "Claro",
    themeDark: "Oscuro",
