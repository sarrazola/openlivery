...
const en = {
  ...
  contacts: {
    ...
    preview: {
      ...
      copy: "Copy",
      copied: "Conversation copied as text.",
      copyFailed: "Could not copy; download it instead.",
...
const es: typeof en = {
  ...
  contacts: {
    ...
    preview: {
      ...
      copy: "Copiar",
      copied: "Conversación copiada como texto.",
      copyFailed: "No se pudo copiar; descárgala en su lugar.",
