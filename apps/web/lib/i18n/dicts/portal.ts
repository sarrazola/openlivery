...
const en = {
  ...
  teams: {
    ...
    form: {
      ...
      descriptionHelp: "The AI reads this to decide where to escalate, so describe what the team handles.",
      members: "Members",
...
const es: typeof en = {
  ...
  teams: {
    ...
    form: {
      ...
      descriptionHelp: "La IA lee esto para decidir a dónde escalar, así que describe qué atiende el equipo.",
      members: "Integrantes",
