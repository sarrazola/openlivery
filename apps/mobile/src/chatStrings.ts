...
const en = {
  ...
  socialBlocked: "Replies unavailable", socialWindowHint: "Wait for a new message from this contact. Templates cannot reopen this channel’s reply window.", socialDisconnected: "Reconnect this account from the channel settings on the web.", socialAuthorization: "Authorize this account again from the channel settings on the web.", socialControl: "Another application controls this conversation. Take control there before replying.", socialHumanOnly: "Human replies only", socialHumanHint: "The approved human support window is active. Automated replies are unavailable after 24 hours.", unsupportedAttachment: "This channel does not support this attachment. Instagram documents must be PDF files.", socialLongText: "Long Instagram replies are sent in multiple parts.",
  ...
  sent: "Sent", delivered: "Delivered", read: "Read", pending: "Sending", unknown: "Delivery unconfirmed", failed: "Delivery failed", activity: "Conversation activity", someone: "Someone",
...
const es: typeof en = {
  ...
  socialBlocked: "No se puede responder", socialWindowHint: "Espera un mensaje nuevo de este contacto. Las plantillas no pueden reabrir la ventana de respuesta de este canal.", socialDisconnected: "Reconecta esta cuenta desde la configuración del canal en la web.", socialAuthorization: "Autoriza esta cuenta otra vez desde la configuración del canal en la web.", socialControl: "Otra aplicación controla esta conversación. Recupera el control allí antes de responder.", socialHumanOnly: "Solo respuestas humanas", socialHumanHint: "La ventana aprobada de atención humana está activa. Las respuestas automáticas no están disponibles después de 24 horas.", unsupportedAttachment: "Este canal no admite este adjunto. Los documentos de Instagram deben ser PDF.", socialLongText: "Las respuestas largas de Instagram se envían en varias partes.",
  ...
  sent: "Enviado", delivered: "Entregado", read: "Leído", pending: "Enviando", unknown: "Entrega sin confirmar", failed: "Error de entrega", activity: "Actividad de la conversación", someone: "Alguien",
